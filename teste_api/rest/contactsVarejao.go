...
func PostContatosVarejao(w http.ResponseWriter, r *http.Request) {
	...
	repo := repositorio.NewRepositorioVarejao(db)
	err = repo.CriarListaVarejao(criarLista)
	if err != nil {
